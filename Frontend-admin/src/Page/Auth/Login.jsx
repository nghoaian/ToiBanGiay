      ...
      <Content className="signin">
        <Row gutter={[24, 0]} justify="center">
          <Col
            ...
            md={{ span: 12 }}
          >
            <Title className="mb-15 nc-align-center" style={{textAlign: 'center'}} >Sign In</Title>
            <form
            ...
            >
              <div className="loginItem">
                ...
                />
                <label htmlFor="email" style={{background: 'rgb(0, 153, 255)'}}>Email</label>
              </div>
              ...
              <div className="loginItem">
                ...
                />
                <label htmlFor="password" style={{background: 'rgb(0, 153, 255)'}}>Password</label>
              </div>
              ...
              <div className="loginItem">
                <Button
                  ...
                  type="primary"
                  htmlType="submit"
                  style={{ background: 'rgb(0, 153, 255)', width: "100%" }}
                >
                  SIGN IN
                </Button>
              </div>
