          ...
          <Container className="my-5 rounded d-flex justify-content-center">
            <Card>
              <CardBody className='d-flex flex-column justify-content-center py-5 px-5'>
                <h5 className="fw-normal text-center my-4 pb-3" style={{ letterSpacing: '1px', padding: 0 , fontSize: 30}}>Sign up</h5>
                <Row>
                  <Col>
                ...
                <Link to={'/login'} className='mt-2' style={{ color: '#0099FF', display: 'inline' }}>Already have an account?</Link>
              </CardBody>
            </Card>
          </Container>
        </Form>
