              ...
              <CardBody className='d-flex flex-column justify-content-center py-5 px-5'>
                <div className='d-flex flex-row align-items-center'>
                  <div className='d-flex'>
                    <h2 className="text-uppercase text-center mt-2 mx-3 fs-1" style={{ color: '#0099FF', display: 'inline' }}>TOI BAN GIAY</h2>
                  </div>
                </div>
                <h5 className="fw-norma text-center my-4 pb-3" style={{ letterSpacing: '1px', padding: 0 }}>Sign in</h5>
                ...
                <Link to={'/register'} className='mt-2' style={{ color: '#0099FF', display: 'inline' }}>Register here</Link>
              </CardBody>
            </Card>
          </Container>
        </Form>
